...
// 		try {
// 			const signUser = await axios.post("/api/signup", signUpData);
...
// 				Username
// 				<input type="text" name="username" className="border-2" required />
// 			</label>
// 			<br />
// 			<label htmlFor="phone">
// 				Phone
// 				<input type="tel" name="phone" className="border-2" required />
// 			</label>
// 			<br />
...
// 				Confirm Password
// 				<input type="password" name="confirm" className="border-2" required />
// 			</label>
// 			<br />
